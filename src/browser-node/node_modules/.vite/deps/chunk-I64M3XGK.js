...
// node_modules/.pnpm/@multiformats+multiaddr-matcher@1.7.0/node_modules/@multiformats/multiaddr-matcher/dist/src/utils.js
var toParts = (ma) => {
...
// node_modules/.pnpm/@multiformats+multiaddr-matcher@1.7.0/node_modules/@multiformats/multiaddr-matcher/dist/src/index.js
var _PEER_ID = peerId();
...
var DNS = fmt(or(_DNS, _DNSADDR, _DNS4, _DNS6), optional(peerId()));
...
var IP_OR_DOMAIN = fmt(or(_IP, and(or(_DNS, _DNSADDR, _DNS4, _DNS6), optional(peerId()))));
var IP4 = fmt(_IP4);
var IP6 = fmt(_IP6);
var IP = fmt(_IP);
...
var _WebSocketsSecure = or(and(_WEB, literal("wss"), optional(peerId())), and(_WEB, literal("tls"), optional(and(literal("sni"), string())), literal("ws"), optional(peerId())));
...
var _WebRTC = or(and(_P2P, literal("p2p-circuit"), literal("webrtc"), optional(peerId())), and(_P2P, literal("webrtc"), optional(peerId())), and(literal("webrtc"), optional(peerId())));
...
var _Memory = or(and(literal("memory"), string(), optional(peerId())));
...
//# sourceMappingURL=chunk-I64M3XGK.js.map
